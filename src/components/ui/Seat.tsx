...
import SelectIcon from '../../assets/images/selected.jpg'
    ...
    return (
        <View className='mb-4 justify-between flex-row'>
            <View className='w-[30%] items-center bg-white rounded-2xl p-4'>
                <Text className='font-okra font-bold text-md mb-4'>Seat Type</Text>
                <View className='items-center mb-4'>
                    <Image source={SelectIcon} className='h-12 w-12 my-1' />
